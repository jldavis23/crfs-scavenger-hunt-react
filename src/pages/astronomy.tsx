...
export default function AstronomyPage() {
    ...
    return (
        <main className="p-5 flex flex-col gap-5 max-w-[600px] m-auto">
            ...
            <p className='text-[15px]'>Capitol Reef Field Station visitors are treated with wonderfully dark skies that can be enjoyed year-round with our telescopes. In 2015, Capitol Reef National Park was designated as an international dark sky park. It offers excellent night-sky viewing.</p>
